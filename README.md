...
| プラットフォーム | 無料プラン | 設定の複雑さ | 起動時間 | 用途 |
|--------------|---------|------------|--------|------|
| [Render](https://render.com) | ✅ あり | 簡単 | 約2分 | 開発・テスト |
| [Railway](https://railway.app) | ✅ あり | 非常に簡単 | 約1分 | 開発・テスト |
| [Vercel](https://vercel.com) | ✅ あり | 簡単 | 約30秒 | フロントエンド |
| [AWS](docs/deployment/aws.md) | ❌ なし | やや複雑 | 約5分 | 本番環境 |
| [GCP](docs/deployment/gcp.md) | ❌ なし | やや複雑 | 約5分 | 本番環境 |
| [Azure](docs/deployment/azure.md) | ❌ なし | やや複雑 | 約5分 | 本番環境 |

### Renderで無料デプロイ（推奨）

1. 上記の「Deploy to Render」ボタンをクリック
2. GitHubアカウントでログイン
3. デフォルト設定のまま「Apply」をクリック
4. 数分後に自動的にデプロイ完了！

詳細な手順は[Renderデプロイガイド](docs/deployment/render-free.md)を参照してください。
...
- [デプロイガイド](docs/deployment/README.md) - 各プラットフォームへのデプロイ方法
