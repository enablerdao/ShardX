...
| ローカル（8コア・最適化版） | 1 | 256 | 1,831,480 | 0.55ms | ✅ 検証済み |
| ローカル（8コア・マルチプロセス） | 8 | 256 | 14,295,174 | 0.07ms | ✅ 検証済み |
...
> 
> 📈 **最新の検証結果**: [パフォーマンステスト結果](docs/benchmarks/performance_results.md)で100,000 TPS達成を確認しました！
