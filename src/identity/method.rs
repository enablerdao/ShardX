...
use crate::crypto::{hash, KeyPair, PrivateKey, PublicKey};
use crate::error::Error;
use crate::identity::did::{
    DIDAuthentication, DIDDocument, DIDMethod, DIDProof, DIDService, DIDVerificationMethod, DID,
};
...
pub trait Method {
    ...
    ) -> Result<(DID, DIDDocument, KeyPair), Error>;
...
impl KeyMethod {
    ...
    pub fn new() -> Self {
        let metadata = MethodMetadata {
            ...
            supported_features: vec!["create".to_string(), "resolve".to_string()],
            limitations: Some(vec!["No update".to_string(), "No deactivate".to_string()]),
            created_at: Utc::now(),
            updated_at: Utc::now(),
            additional_properties: HashMap::new(),
        };
...
impl Method for KeyMethod {
    ...
    fn update(
        ...
        Err(Error::NotImplemented(
            "did:key method does not support update".to_string(),
        ))
    }
    ...
    fn deactivate(&self, did: &DID, key_pair: &KeyPair) -> Result<(), Error> {
        ...
        Err(Error::NotImplemented(
            "did:key method does not support deactivate".to_string(),
        ))
    }
}
...
impl WebMethod {
    ...
    pub fn new() -> Self {
        let metadata = MethodMetadata {
            ...
            limitations: Some(vec!["Requires web server".to_string()]),
            created_at: Utc::now(),
            updated_at: Utc::now(),
            additional_properties: HashMap::new(),
        };
...
impl Method for WebMethod {
    ...
    fn generate(
        ...
        let service = DIDService {
            ...
            service_endpoint: crate::identity::did::ServiceEndpoint::Uri(format!(
                "https://{}",
                domain
            )),
            additional_properties: HashMap::new(),
    ...
    fn update(
        ...
        web_method
            .storage
            .insert(did.to_string(), updated_document.clone());
