...
use shardx::chart::{
    ChartBuilder, ChartDataAggregator, ChartManager, ChartType, DataSeriesBuilder,
    OHLCChartBuilder, OHLCDataSeriesBuilder, TimeFrame,
};
...
fn main() {
    ...
    let (middle_band, upper_band, lower_band) =
        ChartDataAggregator::calculate_bollinger_bands(&price_series.data_points, 10, 2.0);
    ...
    let bollinger_chart =
        ChartBuilder::new("bollinger_chart", ChartType::Line, "ボリンジャーバンド")
